  ...
  const dispatch = useDispatch();
    ...
    const getIssues = async () => {
      try {
        ...
        // Check if the selected book count is greater than zero
        if (selectedBook.count === 0) {
          // Display a message or handle the situation where the book count is zero
          message.warning("Cannot issue the book. Book count is zero.");
